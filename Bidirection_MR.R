...
Exposure = TwoSampleMR::read_exposure_data(filename = "<Cancer_GWAS>",
                                           sep = "\t",
                                           snp_col = "SNP",
...
Exposure$exposure = "<Cancer Types>"
...
Outcome = TwoSampleMR::read_outcome_data(filename = "<Mental_Disorder_GWAS>",
                                         sep = "\t",
                                         snp_col = "SNP",
                                         beta_col = "EFFECT_SIZE",
                                         se_col = "EFFECT_SIZE_STANDARD_ERROR",
